        ...
        options = {
          ...
          server.port = mkOption {
            description = ''
              ...
              This is a read-only option that is read from services.prometheus.exporters.mail-tlsa-check.port.
            '';
            type = types.port;
            default = cfg.port;
            defaultText = "config.services.prometheus.exporters.mail-tlsa-check.port";
            readOnly = true;
          };
          smtp = {
            hostname = mkOption {
            ...
            port = mkOption {
              description = "The SMTP port to monitor";
              type = types.port;
              default = 587;
              example = 465;
            };
          ...
          imap = {
            ...
            port = mkOption {
              description = "The IMAP port to monitor";
              type = types.port;
              default = 143;
              example = 1143;
            };
